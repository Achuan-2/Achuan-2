...
- 神经科学数据处理与分析
   - [Achuan-2/3PM_ROI_imaging_module](https://github.com/Achuan-2/3PM_ROI_imaging_module) : 三光子显微镜ROI成像模块，提升三光子显微镜深度
...
- 思源笔记
   ...
   - [Achuan-2/siyuan-plugin-imgReEditor](https://github.com/Achuan-2/siyuan-plugin-imgReEditor)：思源笔记图片编辑器，已编辑的图片支持再编辑
   ...
   - [Achuan-2/siyuan-plugin-text-process](https://github.com/Achuan-2/siyuan-plugin-text-process) <img src="https://img.shields.io/github/stars/Achuan-2/siyuan-plugin-text-process" alt="stars"> ：思源笔记文本处理插件，支持粘贴时自动处理各种格式
...
- 推荐[Achuan-2 API](https://gpt.achuan-2.top/register?aff=ZndO)：人民币比美刀 0.6:1，按量付费，各个AI模型都能使用，比用官方的API能省不少钱
